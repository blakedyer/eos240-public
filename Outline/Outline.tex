...
\hspace*{\fill}\textbf{SPRING TERM 2026}\\
...
\normalsize Lectures: M/Th 10:00 to 11:20 AM in Elliott 160  \\
\end{center}

\noindent\hrulefill

\textbf{PREREQUISITES}: EOS120, EOS205, CHEM102, 1 of MATH100, MATH102, MATH109\\
...
\begin{center}
  \centering
  \begin{tabular}{ L{.2\linewidth}L{.3\linewidth}L{.35\linewidth} }
...
Teaching Assistant      & Keanna Vaughan Forrester & kvaughanforrester@uvic.ca \\
...
\begin{center}
		\begin{tabular}{ lr }
			Lecture                     & 50\%       \\
			\hline
			~~~Mid-term (Feb 12, week 6)  & 25\%~~~~~~ \\
			~~~Final Exam (date TBA) & 25\%~~~~~~ \\
			Laboratory                  & 50\%       \\
			\hline
			~~~8 Lab Assignments    & 50\%~~~~~~  \\
		\end{tabular}
\end{center}
